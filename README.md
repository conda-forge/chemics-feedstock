...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chemics-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10164&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chemics-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chemics` can be installed with:

```
conda install chemics
```

It is possible to list all of the versions of `chemics` available on your platform with:
